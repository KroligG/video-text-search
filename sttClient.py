...
class WSInterfaceProtocol(WebSocketClientProtocol):
    ...
    def onOpen(self):
        ...
        self.bytesSent = 0
        self.maybeSendChunk(self.uttFileBytes)
        print "onOpen ends"
...
if __name__ == '__main__':
    ...
    parser.add_argument('-credentials', action='store', dest='credentials', help='Basic Authentication credentials in the form \'username:password\'', required=True,
